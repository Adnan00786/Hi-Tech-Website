...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      {isMenuOpen && (
        <div className={`fixed top-0 right-0 h-full w-2/3 md:hidden ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'} shadow-lg z-50 transition-transform transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="p-4">
            <button
